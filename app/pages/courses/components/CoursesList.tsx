        ...
        return (
          ...
          >
            <figure className="relative">
              ...
              <div className="absolute inset-0 flex flex-col justify-center p-3 sm:p-4 opacity-90 bg-primary-dark text-white">
                ...
                <div className="text-xs sm:text-sm font-medium text-text-secondary whitespace-nowrap mt-3">
                  ...
                  <span className="font-bold text-accent-dark capitalize bg-gray-200 px-sm py-1 rounded-lg">{course.status}</span>
                </div>
              </div>
            ...
            <div className="card-body p-2 sm:p-3 md:p-4 text-text">
              ...
              <p className="text-xs sm:text-sm mb-2 sm:mb-3 line-clamp-2 text-text-secondary">{course.description}</p>
              ...
              <div className="flex items-center gap-4">
                <div className="text-xs sm:text-sm">
                  ...
                  {course.discount > 0 ? (
                    <span>
                      <span className="line-through text-text-secondary mr-2">{course.currency} {course.price}</span>
                      <span className="font-bold text-accent-dark">{course.currency} {finalPrice.toFixed(2)}</span>
                    </span>
                  ) : (
                    <span className="font-bold text-accent-dark">{course.currency} {course.price}</span>
                  )}
                </div>
              ...
              <div className="text-xs sm:text-sm text-text-secondary">
                <p>
                  <span className="font-semibold text-text">Posted on: </span> {formatDate(course.createdAt)}
                </p>
                </div>
