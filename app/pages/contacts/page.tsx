    ...
    <div className="min-h-screen max-w-7xl mx-auto">
      <div className="px-md">
        ...
        <div className="mb-md px-1 sm:px-1 md:px-1 lg:px-7">
          <h1 className="text-2xl sm:text-2xl md:text-3xl lg:text-3xl font-bold mb-md mt-lg text-accent-dark">
            Contact Us
          </h1>
          <p className="text-base sm:text-base md:text-lg lg:text-lg max-w-3xl text-text-secondary mt-md">
